...
- **無料**：BASICライブのゲスト参加（1回）、またはPRIMEのゲスト参加（1回）
- **有料**：CONSULT（クイック15万円/スタンダード35万円/ディープダイブ80万円、PRIME会員は20%オフ）
...
**A.** BASICは1回ゲスト参加が可能です。PRIMEもゲスト参加1回まで可能です。ACTIVEはBASICからのアップグレードを推奨します。
...
| プログラム | 料金 |
|-----------|------|
| **BASIC** | 月2,980円 / 年29,800円 |
| **ACTIVE** | 月9,800円 / 年98,000円 |
| **PRIME** | 年220,000円（全サービス20%割引特典付き） |

**都度課金サービス**
| サービス | 通常価格 | PRIME会員価格 |
|---------|---------|--------------|
| **CONSULT｜クイック** | 15万円 | 12万円 |
| **CONSULT｜スタンダード** | 35万円 | 28万円 |
| **CONSULT｜ディープダイブ** | 80万円 | 64万円 |
...
**A.** プログラムにより異なります：
- **BASIC/ACTIVE**：週1時間（ライブ参加）
- **PRIME**：月2–4時間（会合・見学）
- **CONSULT**：1回60分〜半日×2回（コースによる）
- **BOOST**：週4–8時間（プロジェクト稼働）
