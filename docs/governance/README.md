...
私たちは「レポートを書いて終わり」ではなく、90日で可視ROIを出すことにコミットします。
...
- **所属企業・団体**
- **役職・肩書き**
- **金銭的利害関係**（株保有、顧問料、スポンサーシップ等）
- **その他の利害関係**（家族の関与、過去の取引等）

### 名義師範（Named Chair）のルール

特定分野で名前を冠した師範（例：「〇〇 Chair on AI Safety」）は、以下のルールを守ります：

- **発言に不干渉**：名義を貸すのみで、個別の発言・編集には関与しない
- **COI明記**：スポンサー企業等を明記
- **検証QR**：肩書きの検証先URLを設定
...
- **成長パス**:
  - **Named Senior Fellow（名義専門師範）**: Senior Fellow継続3年 + Impact Points 15点以上 + RECIPES執筆2本 → 特定領域の第一人者として名義使用権・優先推薦・報酬+20%
