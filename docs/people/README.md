...
|----------------|-------------------|-----------|--------------|-------------|---------|-------------------|
| 山本（代表理事） | Council Member｜師範会 | 一般社団法人ビジネスAI推進機構 代表理事 | FW-2025-001 | 2026/03/31 | ＜検証URL＞ | 実戦AI道場の方針／公共連携／倫理・COI |
| 佐藤 圭吾 / Keigo Sato（例） | Council Member｜師範会 | BAAO 理事・Program GM | FW-2025-002 | 2026/03/31 | ＜検証URL＞ | 四半期KPI運用／見学プログラム設計／ケース公開主義 |
| （追加） | Council Member｜師範会 | （所属・肩書） | FW-2025-0XX | 20YY/MM/DD | ＜検証URL＞ | （3点） |

> **メモ**：Named Chair（名義師範）はスポンサー表記あり。編集・発言への不干渉（COI）は [Governance（外部要約）](../governance/README.md) を参照。

---

## 現場責任者（Field Directors）
