...
**調査範囲**: Lark、Notion、Lark、Discord、専門コミュニティツール
...
- Lark + Google Workspace + Notionの代替を1つで実現
...
| **チャット（補助）** | Lark/Discord | リアルタイム質問、Office Hours（必要に応じて） |
...
**構成**: Notion + Stripe + Peatix（イベント）+ Lark（オプション）
