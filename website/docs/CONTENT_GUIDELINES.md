# Content Guidelines｜共通トップ & ペルソナ別LP
...
### 2-3. Success Stories（/success-stories）
...
- 送信後の案内：担当からの連絡期限、Lark/オプチャ招待方法、資料送付可否。
...
- 月謝プラン紹介：時間投資・アーカイブ検索・Lark
- コミュニティ：オープンチャット／Larkの雰囲気、モデレーター紹介
