const faqCategories = [
  ...
  {
    category: "月謝プラン（修行者・達人）",
    questions: [
      {
        question: "月謝プランと企業向けプランの違いは？",
        answer:
          "月謝プラン（修行者・達人）は個人で学ぶためのプランで、過去の稽古や知見を検索しながら学べます。企業向けプラン（評議会・伴走・秘伝書）は成果を出すための支援で、専任チームが伴走します。",
      },
      {
        question: "修行者と達人の違いは？",
        answer:
          "修行者（¥2,980/月）は過去の稽古をいつでも視聴でき、週次の知見まとめ配信とLarkでの質問が可能です。達人（¥9,800/月）はそれに加えて、過去の稽古から必要な知見を検索でき、業界別の最新事例まとめと未公開の実装手順書を先行閲覧できます。",
      },
      {
        question: "アーカイブや資料はいつ閲覧できますか？",
        answer:
          "月謝プラン（修行者・達人）に加入すると即時閲覧可能です。",
      },
      {
        question: "月謝プランの料金は？",
        answer:
          "修行者は月額¥2,980（年額¥29,800で2ヶ月分お得）、達人は月額¥9,800です。どちらも7日間無料でお試しいただけます。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: "評議会・伴走・秘伝書の違いは？",
        answer:
          "評議会は経営層向けコミュニティで、未公開ケースや現場見学、月次相談が可能です。伴走は4〜8週のプロジェクト型で、KPIを可視化し横展開のロードマップまで提示します。秘伝書は業務別の実装手順書で、買い切り型です。",
      },
      {
